            ...
            <form onSubmit={handleSignIn} className="space-y-3 lg:space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  <label htmlFor="password" className="block text-sm font-medium text-gray-700 font-[family-name:var(--font-nunito)]">
                    Password
                  </label>
                  <Link href="/auth/forgot-password" className="text-sm text-purple-600 hover:text-purple-700 font-[family-name:var(--font-nunito)]">
                    Forgot password?
                  </Link>
                </div>
